...
<body>
	...
	<div class = "container">
		...
		<form:form modelAttribute="NewBook" 
			action="./add?${_csrf.parameterName}=${_csrf.token}" class = "form-horizontal" enctype="multipart/form-data">
			<fieldset> 
			...
			<div class ="form-group row">
				...
				<div class="col-sm-3">
					<form:textarea path = "publisher" class = "form-control"/>
				</div>
			</div>
			<div class ="form-group row">
		...
		<hr>
		<footer><p>&copy; J's BookMarket</p></footer>
	</div>
</body>
</html>